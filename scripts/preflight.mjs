...
const requiredFiles = [
  'server.js','lib/chat-engine.mjs','schema.sql','package.json',
...
console.log(`Deployment preflight passed: ${requiredFiles.length} runtime files verified. .env.example is optional and is never required for production.`);
